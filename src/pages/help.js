    ...
    categories : {
       "Κατοικίδια": [
          ...
          { 
            ...
            answer: "Δεν μπορείτε εσείς να προσθέσετε νέο κατοικίδιο. Μπορείτε να κλείσετε ραντεβού με ένα κτηνίατρο και να καταχωρήσει εκείνος το νεό σας κατοικίδιο." 
          },
        ],
        "Λογαριασμός & Προφίλ": [
          { 
    ...
    categories : {
       "Δημόσιο Προφίλ": [
        ...
        "Ραντεβού & Διαθεσιμότητα": [
          ...
          {
            question: "Μπορώ να δω το ιστορικό των ραντεβού μου;",
            answer: "Ναι, στη σελίδα 'Διαχείριση Ραντεβού' υπάρχει η καρτέλα 'Ιστορικό Ραντεβού' όπου μπορείτε να δείτε όλα τα παρελθοντικά ραντεβού που έχετε πραγματοποιήσει για κάθε ζώο."
          }
        ],
        "Διαχείριση Ζώων": [
          {
